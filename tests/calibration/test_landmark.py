...
from lerobot.calibration.transforms import compose_transforms, make_transform
...
def test_robot_to_landmark_chain():
    ...
    expected = compose_transforms(T_robot_to_ee, compose_transforms(T_ee_to_cam, T_landmark_to_cam))
